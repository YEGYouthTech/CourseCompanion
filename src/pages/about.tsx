      ...
      <div className="flex flex-col">
        <div className="flex flex-col mt-8">
          <div className="container px-4 max-w-7xl">
            ...
            <div className="flex flex-wrap justify-center px-6 mb-16 sm:px-16">
              <ExecMember
                name="Oliver Chen"
            ...
            <div className="flex flex-wrap max-w-4xl mx-auto">
              <div className="w-full px-6 mb-6 sm:px-6 md:w-6/12 lg:w-6/12 lg:px-4">
                <div className="flex flex-col">
            ...
            <div className="flex flex-wrap justify-center py-16">
              <div className="w-full px-6 mb-6 sm:px-6 md:w-6/12 lg:w-3/12 lg:px-4">
                <div className="flex flex-col items-center">
                  <span className="text-base font-medium text-gray-100/75">
                    And a huge thank you to...
                  </span>
                  <h1 className="mt-2 mb-8 text-xl font-bold text-center text-gray-100">
