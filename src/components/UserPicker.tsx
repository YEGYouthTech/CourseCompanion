    ...
    <Combobox value={selected} onChange={setSelected}>
      <div className="relative mt-1 flex gap-4">
        <div className="relative grow cursor-default overflow-hidden rounded-lg bg-zinc-800 text-left shadow-md focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-teal-300 sm:text-sm">
          <Combobox.Input
            className="w-full border-none bg-zinc-800 py-2 pl-3 pr-10 text-sm leading-5 text-gray-200 outline-none focus:ring-0"
        ...
        <Transition
          ...
          afterLeave={() => setQuery('')}
        >
          <Combobox.Options className="absolute z-50 mt-10 max-h-60 w-full overflow-auto rounded-md bg-zinc-800 py-1 text-base shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
